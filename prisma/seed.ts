...
async function main() {
  ...
  await prisma.trek.upsert({
    ...
    create: {
      ...
      price: 1899, duration: 14,
      difficulty: "challenging", region: "everest",
      overview: "<p>The Everest Base Camp trek is the ultimate Himalayan adventure.</p>",
      bestTime: "Mar-May, Sep-Nov", maxAltitude: 5364,
  ...
  await prisma.trek.upsert({
    ...
    create: {
      ...
      price: 1599, duration: 16,
      difficulty: "moderate", region: "annapurna",
      overview: "<p>One of the world's classic treks.</p>",
      bestTime: "Mar-May, Sep-Nov", maxAltitude: 5416,
  ...
  await prisma.trek.upsert({
    ...
    create: { categoryId: treksCat.id,
      ...
      price: 1199, duration: 10,
      difficulty: "moderate", region: "annapurna",
      overview: "<p>A hidden gem in the Annapurna region.</p>",
      bestTime: "Mar-May, Sep-Nov", maxAltitude: 4500,
